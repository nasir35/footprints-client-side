...
const Blog = () => {
    ...
    return (
        <div className="">
            ...
            <Link to="add-a-blog"><button className="block bg-green-custom text-white p-1 px-10 rounded mb-5 hover:bg-green-500 text-center mx-auto">Add a Blog</button></Link>
